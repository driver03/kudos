...
$(info  EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF)
$(info  MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NONINFRINGEMENT.)
$(info  IN NO EVENT SHALL THE AUTHORS OR COPYRIGHT HOLDERS BE LIABLE FOR ANY)
$(info  CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT,)
$(info  TORT OR OTHERWISE, ARISING FROM, OUT OF OR IN CONNECTION WITH THE)
$(info  SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE.)
$(info )
